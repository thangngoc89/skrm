...
type value_content = (string, string);
...
let b4 = {
  id: Id.make("b4"),
  question: {j|Theo cháu cảm nhận, thì cháu thấy tình trạng **răng** của mình thế nào?|j},
  content: [|
    ("1", {j|Hoàn toàn lành mạnh|j}),
    ("2", {j|Rất tốt|j}),
    ("3", {j|Tốt|j}),
    ("4", {j|Trung bình|j}),
    ("5", {j|Không được tốt lắm|j}),
    ("6", {j|Hoàn toàn không tốt|j}),
    ("9", {j|Không biết|j}),
  |],
};
...
let b5 = {
  id: Id.make("b5"),
  question: {j|Theo cháu cảm nhận, thì cháu thấy tình trạng **nướu** của mình thế nào?|j},
  content: [|
    ("1", {j|Hoàn toàn lành mạnh|j}),
    ("2", {j|Rất tốt|j}),
    ("3", {j|Tốt|j}),
...
let b6 = {
  id: Id.make("b6"),
  question: {j|Trong suốt 12 tháng vừa qua, có khi nào cháu cảm thấy bị đau răng hay cảm thấy bị khó chịu vì răng miệng của mình không?|j},
  content: [|
    ("1", {j|Thường xuyên|j}),
    ("2", {j|Thỉnh thoảng|j}),
    ("3", {j|Hiếm khi|j}),
