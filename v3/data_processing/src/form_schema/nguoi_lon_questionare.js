...
var fields = [
    {
        type: "note",
        label: "Bảng câu hỏi này dùng để nghiên cứu mối liên quan giữa những hiểu biết về bệnh sâu răng, thói quen chăm sóc răng miệng và tình trạng bệnh sâu răng. Kính xin các Ông/Bà vui lòng dành thời gian trả lời chính xác các câu hỏi sau đây, bằng cách đánh dấu (X) vào ô mà Ông/Bà chọn là câu trả lời. Xin cảm ơn."
    },
    {
        type: "select_one",
        name: "a1",
    ...
    },
    {
        type: "select_one",
        name: "a6",
        label: "Trong suốt 12 tháng vừa qua, có khi nào ông/bà cảm thấy bị đau răng hay cảm thấy bị khó chịu vì răng miệng của mình không?",
        choices: [
            { name: "1", label: "Có" },
            { name: "2", label: "Không" },
    ...
    },
    {
        ...
        label: "Về tình trạng răng miệng, bao lâu thì ông/bà có bất kì triệu chứng nào dưới đây trong vòng 12 tháng trở lại đây?",
        choices: [
    ...
    },
    {
        name: "a10",
        type: "matrix_select_one",
        label: "Nếu bây giờ ông/bà phải đến khám ở một phòng nha, thì ông/bà nghĩ nha sĩ sẽ nói với ông/bà điều gì? Nha sĩ sẽ nói với ông/bà rằng (đọc từng câu một):",
        choices: [
            { name: "1", label: "Có" },
            { name: "0", label: "Không" },
