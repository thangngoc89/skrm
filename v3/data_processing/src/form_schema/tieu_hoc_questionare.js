...
var fields = [
    ...
    },
    {
        type: "select_one",
        name: "b6",
        label: "Trong suốt 12 tháng vừa qua, có khi nào cháu cảm thấy bị đau răng hay cảm thấy bị khó chịu vì răng miệng của mình không?",
        choices: [
    ...
    },
    {
        ...
        label: "Nếu bây giờ cháu phải đến khám ở một phòng nha, thì cháu nghĩ nha sĩ sẽ nói với cháu điều gì? Nha sĩ sẽ nói với cháu rằng (đọc từng câu một):",
        choices: [
            { name: "1", label: "Có" },
            { name: "0", label: "Không" },
            { name: "9", label: "Không biết" },
